...
public:
    ...
    void setupUi(QWidget *Mode_hw_tw)
    {
        ...
        txtb_enc1_speed->setGeometry(QRect(10, 60, 61, 20));
        txtb_enc1_speed->setReadOnly(true);
        groupBox_2 = new QGroupBox(Mode_hw_tw);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(210, 40, 81, 121));
        ...
        txtb_motor0_pos_deadband->setGeometry(QRect(10, 30, 61, 20));
        ...
        txtb_motor1_pos_deadband->setGeometry(QRect(10, 60, 61, 20));
        groupBox_3 = new QGroupBox(Mode_hw_tw);
        groupBox_3->setObjectName(QString::fromUtf8("groupBox_3"));
        groupBox_3->setGeometry(QRect(300, 40, 81, 121));
        ...
        txtb_motor0_neg_deadband->setGeometry(QRect(10, 30, 61, 20));
