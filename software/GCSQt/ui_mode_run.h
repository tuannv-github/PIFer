...
public:
    ...
    void retranslateUi(QWidget *Mode_run)
    {
        ...
        tb_initial_state_y->setText(QApplication::translate("Mode_run", "0", nullptr));
        tb_initial_state_x->setText(QApplication::translate("Mode_run", "0", nullptr));
