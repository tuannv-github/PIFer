...
public class CRC {
    ...
    static {
        ...
        MAVLINK_MESSAGE_CRCS.put(4, 83);
        MAVLINK_MESSAGE_CRCS.put(5, 93);
        MAVLINK_MESSAGE_CRCS.put(6, 54);
        MAVLINK_MESSAGE_CRCS.put(7, 183);
        MAVLINK_MESSAGE_CRCS.put(8, 75);
        MAVLINK_MESSAGE_CRCS.put(9, 30);
        MAVLINK_MESSAGE_CRCS.put(10, 170);
        MAVLINK_MESSAGE_CRCS.put(11, 8);
        MAVLINK_MESSAGE_CRCS.put(12, 31);
        MAVLINK_MESSAGE_CRCS.put(13, 253);
        MAVLINK_MESSAGE_CRCS.put(14, 22);
        MAVLINK_MESSAGE_CRCS.put(15, 118);
        MAVLINK_MESSAGE_CRCS.put(16, 2);
        MAVLINK_MESSAGE_CRCS.put(17, 198);
        MAVLINK_MESSAGE_CRCS.put(18, 92);
        MAVLINK_MESSAGE_CRCS.put(19, 91);
        MAVLINK_MESSAGE_CRCS.put(20, 35);
        MAVLINK_MESSAGE_CRCS.put(21, 170);
        MAVLINK_MESSAGE_CRCS.put(22, 244);
        MAVLINK_MESSAGE_CRCS.put(23, 33);
        MAVLINK_MESSAGE_CRCS.put(24, 4);
        MAVLINK_MESSAGE_CRCS.put(25, 177);
        MAVLINK_MESSAGE_CRCS.put(26, 71);
        MAVLINK_MESSAGE_CRCS.put(27, 103);
        MAVLINK_MESSAGE_CRCS.put(28, 183);
        MAVLINK_MESSAGE_CRCS.put(29, 72);
